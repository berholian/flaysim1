    ...
    <section>
      ...
      <div class="row carta">
        ...
        <div class="paper col8">
          <h4>
            <a data-destino="#sim_personaliz_en">simuladores personalizados</a>
          </h4>
        ...
        <div class="paper col8">
          <h4>
            <a data-destino="#mantenimiento_ampliacion_en">mantenimiento y ampliación</a>
          </h4>
        ...
        <div class="paper col8">
          <h4>
            <a data-destino="#componentes_reales_en">componentes reales</a>
          </h4>
